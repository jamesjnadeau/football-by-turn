 ...
 *
 * `teamSize` is written out rather than read off the roster on purpose. It is a
 * claim ABOUT the game the button starts, and the test that holds every playable
 * variant against the roster it actually fields is what stops this list quietly
 * lying about it.
 */
