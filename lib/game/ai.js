...
export const AI_MODES = [
  ...
  },
  {
    ai: 'both',
    level: 'learned',
    label: 'Both teams: computer',
    note: 'The computer plays both sides. Press the gift button any time to see its plan, or just press End Turn and it fills in whatever you left blank.',
  },
  {
    ai: null,
    level: 'smart',
...
export function aiModeIndex(state) {
  if (state.aiBoth) return AI_MODES.findIndex((m) => m.ai === 'both');
