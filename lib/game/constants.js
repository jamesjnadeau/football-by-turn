...
// sizes the un-scaled reach the velocity triangle's circumradius is built
// from; DEBUG_VELOCITY_TRIANGLE_SCALE below is what turns it into the size
// actually drawn.
export const DEBUG_VELOCITY_SECONDS = 0.25;
// That reach is sized right to draw as a *line*, but far too large as the
// circumradius of a *filled* triangle — at top speed (a skill player's 60
// u/s) the unscaled reach is seven times the player's own 2.5-unit body. A
// fifth of it puts the triangle at 3.5 units at top speed: a shade larger
// than the player, so it reads as a marker on him rather than swallowing
// him.
export const DEBUG_VELOCITY_TRIANGLE_SCALE = 0.2;
