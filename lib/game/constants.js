...
// The friction arc: the orange rim drawn on a man where an opponent is leaning
// on him. An arc rather than a ring because the DIRECTION is the information —
// a coach reading the board wants to see which way he is being pushed, and
// from how many sides at once. Sixty degrees is wide enough to read at a
// glance on a man the size of a skill player, and still narrow enough that two
// arcs on the same man stay visibly separate.
export const FRICTION_ARC_DEGREES = 60;
