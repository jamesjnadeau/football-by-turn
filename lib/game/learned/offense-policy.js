 ...
 *
 * Turn 0 is the huddle: the call gate picks the play and the down's own call
 * (read.js's setCalledPlay) remembers it. Every turn after runs it: a passing
 * QB re-releases his receivers, protects, and throws when someone clears the
 * bar (or scrambles once he legally can't throw and the hold clock is spent);
 * any other carrier finds daylight behind blocks; a loose ball is everyone's
 * problem.
 */
