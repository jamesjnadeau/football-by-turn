...
/** The middle of the column, which is the middle of the drawn field. */
function buttonColumnMidY() {
  const view = gameView(0);
  return (view.fieldTopY + yardToY(view, END_YARD)) / 2;
}
