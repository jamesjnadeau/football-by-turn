...
// What a perfectly-read down is worth, in yards. The read's own consumer — a
// coverage shade — moves yards allowed by less than this evaluation's noise, so
// nothing in the terms above can tell a defense that reads the play from one
// that guesses. This term does, and it is why it exists: not because being right
// is intrinsically worth points, but because a signal too small to select on is
// a signal that trains to noise.
export const READ_ACCURACY_YARDS = 2;
