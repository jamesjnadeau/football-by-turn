...
const WHERE_THEY_STAND = {
  ...
  // separately, off showsMenu() below, keyed to the one step whose allow is
  // 'menu'. It still has to be named here: a control has to be fielded before
  // it can be ringed, and this is what lets that last step put a ring on it.
