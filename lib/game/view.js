...
export function gameView(losYard) {
  return {
    ...
    goalYard: GOAL_YARD,
    goalPosts: true,
    // No legend down this sideline: render.js puts a clipboard button there
    // instead, which opens the menu the words used to name. Null rather than
    // undefined — undefined would fall back to the diagrams' PRESS BOX.
    sidelineLabel: null,
